...
class WP_EDU_API_Host {
    ...
    public function get_student_grades( WP_REST_Request $request ) {
        ...
        // GÜVENLİK DÜZELTMESİ: Token'ı hem Header'dan hem de URL'den yakala (Sunucu engellerine karşı)
        ...
        if ( $posts ) {
            foreach ( $posts as $post ) {
                // HESAPLAMA GÜVENLİĞİ: Eğer süre NULL (boş) ise sayfayı çökertmemesi için yayın tarihini baz al.
